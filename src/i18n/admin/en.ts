...
const adminEn = {
  ...
  schedule: {
    ...
    manualApprovalSub:       'When enabled, new bookings require your approval before being confirmed.',
    ...
    save:                    'Save schedule',
    saved:                   'Saved!',
    unsavedBanner:           'Unsaved changes — don\'t forget to save!',
    saveNow:                 'Save now',
  },
  ...
  share: {
    ...
    btnSectionTitle: 'Add a booking button to your website',
    btnSectionSub:   'Customise the label and colour, then paste the snippet anywhere on your site.',
    btnTextLabel:    'Button text',
    btnTextPlaceholder: 'e.g. Book a visit',
    btnColourLabel:  'Colour',
    copyCode:        'Copy code',
    copy:            'Copy',
    open:            'Open',
  },
