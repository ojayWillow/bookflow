...
const ru: PublicDict = {
  ...
  pricing: {
    sectionTitle: 'Один тариф. Всё включено.',
    sectionSub:   'Попробуйте бесплатно 7 дней. Карта обязательна, отмена в любое время.',
    perWeek:      '/ неделю',
    afterTrial:   'после 7-дневного бесплатного периода',
    cancelNote:   'Отмена в любое время. Без обязательств. Без сюрпризов.',
    cta:          'Начать бесплатный период →',
    features: [
      'Неограниченно услуг',
      'Страница онлайн-записи',
      'Подтверждения по e-mail',
  ...
  cta: {
    ...
    sub:      'Попробуйте BookFlow бесплатно 7 дней. Без обязательств.',
  ...
  booking: {
    ...
    noServicesTitle:     'Нет доступных услуг',
    noServicesSub:       'Этот бизнес ещё не добавил ни одной услуги.',
