...
const ru: PublicDict = {
  ...
  pricing: {
    ...
    sectionSub:   'Попробуйте бесплатно 7 дней. Карта не нужна.',
    ...
    plans: [
      ...
      {
        name: 'Pro',
        features: ['Собственный домен', 'SMS-напоминания', 'Аналитика', 'Несколько точек', 'Приоритетная поддержка'],
      },
      {
        name: 'Агентство',
        features: ['White-label перепродажа', 'Доступ к API', 'Персональный менеджер', 'Кастомные интеграции'],
      },
    ],
  },
