...
export default function StepDetails({ form, errors, touched, dict: t, onChange, onBlur, onNext }: Props) {
  ...
  return (
    <div>
      ...
      <p className="text-gray-400 text-sm mb-6">{t.stepDetailsSub}</p>

      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1.5">{t.labelName} <span className="text-red-400">*</span></label>
          ...
          {touched.name && !errors.name && <p className="text-xs text-green-600 mt-1.5">✓ {t.looksGood}</p>}
        </div>

        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1.5">{t.labelEmail} <span className="text-red-400">*</span></label>
          ...
          {touched.email && !errors.email && <p className="text-xs text-green-600 mt-1.5">✓ {t.looksGood}</p>}
        </div>

        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1.5">{t.labelPhone} <span className="text-red-400">*</span></label>
          ...
          {touched.phone && !errors.phone && <p className="text-xs text-green-600 mt-1.5">✓ {t.looksGood}</p>}
        </div>
        ...
        <div>
          ...
          <textarea value={form.notes} onChange={e => onChange('notes', e.target.value)}
            ...
            rows={3} placeholder={t.placeholderNotes} />
        </div>
      </div>
