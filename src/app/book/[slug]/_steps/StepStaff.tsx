      ...
      {loading ? (
        ...
        <div className="space-y-2">
          <button onClick={() => onSelect('any')}
            className={`w-full text-left bg-white border-2 rounded-xl px-4 py-3 hover:border-indigo-400 transition-all ${
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-gray-900 text-sm">{t.anyoneAvailable}</p>
                <p className="text-xs text-gray-400">{t.anyoneAvailableSub}</p>
              </div>
            </div>
          </button>
