    ...
    <tr><td align="center">
      <table width="100%" style="max-width:560px;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,0.08)">
            ...
            <tr><td style="padding:20px">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td style="padding:6px 0;color:#111827;font-size:13px;font-weight:600">${b.serviceName}</td>
                </tr>
                <tr>
                  <td style="padding:6px 0;color:#6b7280;font-size:13px">Date</td>
                  <td style="padding:6px 0;color:#111827;font-size:13px;font-weight:600">${formatDate(b.date)}</td>
                </tr>
                <tr>
                  <td style="padding:6px 0;color:#6b7280;font-size:13px">Time</td>
                  <td style="padding:6px 0;color:#111827;font-size:13px;font-weight:600">${formatTime(b.time)}</td>
                </tr>
                <tr>
                  <td style="padding:6px 0;color:#6b7280;font-size:13px">Duration</td>
                  <td style="padding:6px 0;color:#111827;font-size:13px;font-weight:600">${b.serviceDuration} min</td>
                </tr>
                <tr>
                  <td style="padding:6px 0;color:#6b7280;font-size:13px">Staff</td>
                  <td style="padding:6px 0;color:#111827;font-size:13px;font-weight:600">${b.staffName}</td>
                </tr>
                <tr>
                  <td style="padding:6px 0;color:#6b7280;font-size:13px">Price</td>
                  <td style="padding:6px 0;color:#111827;font-size:13px;font-weight:600">${formatPrice(b.servicePrice, b.serviceCurrency)}</td>
                </tr>
              </table>
            </td></tr>
          </table>
        ...
        <tr><td style="padding:0 32px 24px">
          <p style="margin:0 0 6px;color:#6b7280;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:0.05em">Location</p>
          <p style="margin:0;color:#111827;font-size:13px">${b.businessAddress}</p>
        </td></tr>` : ''}
        ...
        <tr><td style="padding:0 32px 24px">
          <div style="background:#fefce8;border:1.5px solid #fde68a;border-radius:10px;padding:14px 16px">
            <p style="margin:0 0 4px;color:#92400e;font-size:12px;font-weight:600">Cancellation policy</p>
            <p style="margin:0;color:#78350f;font-size:12px;line-height:1.5">${b.cancellationPolicy}</p>
          </div>
        </td></tr>` : ''}
        ...
        <tr><td style="padding:24px 32px">
          ...
          <table width="100%" style="background:#f9fafb;border-radius:12px">
            <tr><td style="padding:20px">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="padding:5px 0;color:#6b7280;font-size:13px;width:40%">Service</td>
                  <td style="padding:5px 0;color:#111827;font-size:13px;font-weight:600">${b.serviceName}</td>
                </tr>
                <tr>
                  <td style="padding:5px 0;color:#6b7280;font-size:13px">Date</td>
                  <td style="padding:5px 0;color:#111827;font-size:13px;font-weight:600">${formatDate(b.date)}</td>
                </tr>
                <tr>
                  <td style="padding:5px 0;color:#6b7280;font-size:13px">Time</td>
                  <td style="padding:5px 0;color:#111827;font-size:13px;font-weight:600">${formatTime(b.time)}</td>
                </tr>
                <tr>
                  <td style="padding:5px 0;color:#6b7280;font-size:13px">Duration</td>
                  <td style="padding:5px 0;color:#111827;font-size:13px;font-weight:600">${b.serviceDuration} min</td>
                </tr>
                <tr>
                  <td style="padding:5px 0;color:#6b7280;font-size:13px">Staff</td>
                  <td style="padding:5px 0;color:#111827;font-size:13px;font-weight:600">${b.staffName}</td>
                </tr>
                <tr>
                  <td style="padding:5px 0;color:#6b7280;font-size:13px">Price</td>
                  <td style="padding:5px 0;color:#111827;font-size:13px;font-weight:600">${formatPrice(b.servicePrice, b.serviceCurrency)}</td>
                </tr>
              </table>
            </td></tr>
          </table>
          ...
          <table width="100%" style="background:#f9fafb;border-radius:12px">
            <tr><td style="padding:20px">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="padding:5px 0;color:#6b7280;font-size:13px;width:40%">Name</td>
                  <td style="padding:5px 0;color:#111827;font-size:13px;font-weight:600">${b.customerName}</td>
                </tr>
                <tr>
                  <td style="padding:5px 0;color:#6b7280;font-size:13px">Email</td>
                  <td style="padding:5px 0;font-size:13px"><a href="mailto:${b.customerEmail}" style="color:#4f46e5">${b.customerEmail}</a></td>
                </tr>
                <tr>
                  <td style="padding:5px 0;color:#6b7280;font-size:13px">Phone</td>
                  <td style="padding:5px 0;font-size:13px"><a href="tel:${b.customerPhone}" style="color:#4f46e5">${b.customerPhone}</a></td>
                </tr>
                ${b.customerNotes ? `
                <tr>
                  <td style="padding:5px 0;color:#6b7280;font-size:13px;vertical-align:top">Notes</td>
                  <td style="padding:5px 0;color:#374151;font-size:13px">${b.customerNotes}</td>
                </tr>` : ''}
              </table>
            </td></tr>
          </table>
...
export async function POST(req: NextRequest) {
  try {
    ...
    const businessEmail       = biz?.email             ?? process.env.SMTP_FROM!
    ...
    // 3. Send emails (non-blocking — booking is already saved if this fails)
    const from = `${businessName} <${process.env.SMTP_FROM}>`
